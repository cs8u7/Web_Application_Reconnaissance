...
def hidden_and_document_endpoint(endpoint_sample,folder_sample):
   hidden_sample = folder_sample + '/' + folder_sample + '@hidden.txt'
   print('[-] Reading URLs')
   with open(endpoint_sample, 'r') as file:
      url_lines = file.readlines()
   with open('module/hidden_wordlist.txt', 'r') as file:
   ...
   document_sample = folder_sample + '/' + folder_sample + '@document.txt'
   document_set = []
   doc_temps = ['.txt','.pdf','.doc','xlsx','xls','ods','docx','ppt','pptx']
